...
<div class="container mx-auto px-4 py-8 bg-gray-900 text-gray-100">
    <div class="max-w-2xl mx-auto bg-gray-800 rounded-lg shadow-lg p-4 md:p-8">
        {{-- Header Section --}}
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <a href="{{ route('author.dashboard') }}" class="flex items-center bg-gray-700 text-white px-3 py-2 rounded-lg hover:bg-gray-600 transition text-sm">
        ...
        <form method="POST" action="{{ route('author.profile.update') }}" class="space-y-6">
            ...
            <button type="submit" class="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-500 transition">Update Profile</button>
        </form>
    </div>
</div>
@endsection