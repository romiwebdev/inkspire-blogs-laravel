<footer class="bg-gray-900 text-gray-100">
    ...
    <span class="text-2xl font-medium tracking-wide text-blue-600 font-['Lora']">INKSPIRE</span>
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                <!-- Community -->
                <div>
                    <h2 class="mb-6 text-sm font-semibold uppercase">Community</h2>
                    <ul class="font-medium">
                        <li class="mb-4">
                            <a href="#" class="hover:underline text-gray-400">Our Writers</a>
                        </li>
                        <li>
                            <a href="#" class="hover:underline text-gray-400">Join Us</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="font-medium">
                        ...
                        <li>
                            <a href="#" class="hover:underline text-gray-400">Contact Us</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="font-medium">
                        ...
                        <li>
                            <a href="#" class="hover:underline text-gray-400">Terms & Conditions</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-400 sm:text-center">© 2024 <a href="#" class="hover:underline">Inkspire</a>. All Rights Reserved.</span>
            <div class="flex mt-4 sm:justify-center sm:mt-0 space-x-5">
                <a href="#" class="text-gray-400 hover:text-white">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" />
                    </svg>
                    <span class="sr-only">Facebook page</span>
                </a>
                <a href="#" class="text-gray-400 hover:text-white">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 21 16">
