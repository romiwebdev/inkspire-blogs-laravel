    ...
    <div class="max-w-4xl mx-auto bg-gray-800 rounded-lg shadow-lg p-4 md:p-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-8">
            <h1 class="text-2xl md:text-3xl font-bold text-white flex items-center mb-4 md:mb-0">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 md:h-8 w-6 md:w-8 mr-3 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <form action="{{ route('posts.store') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input 
                        ...
                        required 
                        value="{{ old('title') }}"
                        class="w-full pl-10 pr-3 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-white placeholder-gray-500"
                    >
                </div>
                @error('title')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <select 
                        ...
                        name="category_id" 
                        required 
                        class="w-full pl-10 pr-3 py-2 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-white"
                    >
            ...
            <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4">
                <button 
                    type="submit" 
                    class="flex-1 bg-green-600 text-white py-2 rounded-lg hover:bg-green-500 transition flex items-center justify-center"
                >
